...
with st.sidebar:
    ...
    <div style="text-align: center; margin-top: 50px;">
        <a class="button" href="https://github.com/Mujeeb-Akbar" target="_blank" rel="noopener noreferrer">Visit my GitHub</a>
    </div>
    ...
    <div style="padding:10px; text-align:center;margin-top: 10px;">
        <p style="font-size:20px; color:#ffffff;">Made with ❤️ by Engr. Mujeeb Akbar</p>
    </div>
    """
